...
function bounce(ball, paddle)
     ...
     offset = (ball.x - paddle_center) / (paddle.w / 2)
				
					if offset >= -0.5 and offset <= 0.5 then
		    -- ball hit near the center
		    ball.vel_y = - ball.speed -- go up
					else
					    -- ball hit away from center
...
function brick_draw()
    ...
    for brick in all(bricks) do
        spr(brick.sprite, brick.x, brick.y, 1, 1) -- assuming sprite 2 is your brick
    end
    
end
__gfx__

